...
El tipo de dato =VAR= pierde su valor o regresa a su valor definido al inicio al correr de nuevo el programa =main=, es decir, no guarda en memoria el ultimo dato si es que se cambio en algún momento en la lógica. es =PERS=
